...
#define syntax2 \
" id=cropfix crop aux=[ ref=cropfix ] id=sl gimp:layer-mode layer-mode=screen blend-space=rgb-perceptual aux=[ ref=sl softglow glow-radius=50  brightness=0.42 sharpness=0.357  gimp:layer-mode layer-mode=overlay blend-space=rgb-perceptual opacity=0.71 aux=[ color value=#afafaf ] crop aux=[ ref=cropfix ] id=gaus gimp:layer-mode layer-mode=luminance opacity=0.65 aux=[ ref=gaus gaussian-blur abyss-policy=none clip-extent=false std-dev-x=8 std-dev-y=8 ] levels in-high=1.2 out-high=1.0 "\
